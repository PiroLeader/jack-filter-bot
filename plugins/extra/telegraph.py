...
async def telegraph_upload(bot, update):
    ...
    if not file_info:
        ...
        return
    text = await update.reply_text(text="<code>Dᴏᴡɴʟᴏᴀᴅɪɴɢ...</code>", disable_web_page_preview=True)   
    media = await update.reply_to_message.download()   
    await text.edit_text(text="<code>Uᴘʟᴏᴀᴅɪɴɢ ʏᴏᴜʀ ɪᴍᴀɢᴇ...</code>", disable_web_page_preview=True)                                            
    try:
